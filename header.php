<header>
    ...
    session_start();
    $errorMsg = "";
    include($_SERVER['DOCUMENT_ROOT'] . "/HackBox/connection.php");
    ...
    <nav>
        <div class="wrapper">
            ...
            <ul class="nav-links">
                ...
                <li><a href="/HackBox/index.php">Home</a></li>
                <li><a href="/HackBox/about.php">About</a></li>
                <li>
                    ...
                    <ul class="drop-menu">
                        ...
                        if (isset($currentLevel)) {
                            for ($i = 0; $i < $currentLevel + 1 && $i < 5 ; $i++) {
                                echo '<li><a href="/Hackbox/Challenge_' . ($i + 1) . '">Challenge ' . ($i + 1) . '</a></li>';
                            }
                        }
                        ?>
                    </ul>
                ...
                if (isset($_SESSION['userName'])) {
                    echo '<li><a href="#" class="desktop-item">' . $_SESSION['userName'] . '</a>
                     ...
                     <ul class="drop-menu">
                      <li><a href="/Hackbox/logout.php">Log Out</a></li>
                     </ul></li>';
                } else {
                    echo '<li><a href="/Hackbox/login.php">Login</a></li>
                <li><a href="/Hackbox/register.php">Register</a></li>';
                }
                ?>
            </ul>
